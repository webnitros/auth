...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     * @return void
     */
    public function __construct(Route $routes, Request $request, $assetRoot = null)
    {
        $this->routes = $routes;
        $this->assetRoot = $assetRoot;

        $this->setKeyResolver(function () {
            return 'dmowwqjndo812d7h19d7128d';
        });
    ...
    public function signedRoute($name, $parameters = [], $expiration = null, $absolute = true)
    {
        ...
        $routeKey = $this->route($name, $parameters, $absolute);
        $routeKey = ltrim($routeKey, ':');
        return $this->route($name, $parameters + [
                'signature' => hash_hmac('sha256', $routeKey, $key),
            ], $absolute);
    }
    ...
    {
        $url = $this->signedRoute($name, $parameters, $expiration, $absolute);
        return ltrim($url, ':');
    }
    ...
    public function hasCorrectSignature(Request $request, $absolute = true)
    {
        ...
        $compare = (string)$request->query('signature', '');
